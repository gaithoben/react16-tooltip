    ...
    return (
      <div>
        ...
        <ol>
          <li>
            Hover on{' '}
            <Origin name="text" className="target" delay>
              an origin element
            </Origin>
          </li>
        ...
        <Tooltip
          name="text"
          onHover={this.handleHover.of('text')}
          onLeave={this.handleLeave.of('text')}
        >
        ...
        <p>
          This tooltip has{' '}
          <Origin name="svg" className="target" delay>
            SVG
          </Origin>{' '}
          content.
        </p>
        ...
        <Tooltip
          name="svg"
          onHover={this.handleHover.of('svg')}
          onLeave={this.handleLeave.of('svg')}
        >
