    ...
    return (
      <div>
        ...
        <p>
          ...
          <span ref="target" className="target">
            following buttons
          </span>.
        </p>
        ...
        <p>
          <input
            type="button"
            value="Top"
            onClick={() => this.handlePlace('top')}
          />{' '}
          <input
            type="button"
            value="Right"
            onClick={() => this.handlePlace('right')}
          />
          <span> </span>
          <input
            type="button"
            value="Bottom"
            onClick={() => this.handlePlace('bottom')}
          />{' '}
          <input
            type="button"
            value="Left"
            onClick={() => this.handlePlace('left')}
          />
        </p>
