    ...
    return (
      <div>
        ...
        <p>
          ...
          <Origin className="target" name="green">
            Green
          </Origin>{' '}
          tooltip and{' '}
          <Origin className="target" name="red">
            Red
          </Origin>{' '}
          tooltip.
        </p>
        ...
        <p>
          If you pass a list of tooltip names as 'name' props, the specified
          tooltips will be shown{' '}
          <Origin className="target" name={['green', 'red']}>
            at once
          </Origin>.
        </p>
