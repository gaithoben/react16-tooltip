  ...
  render() {
    ...
    return (
      <div>
        ...
        <p>
          If you provide a{' '}
          <Origin className="target custom" content="This is a custom content.">
            custom
          </Origin>{' '}
          content via Origin component's prop, it will overwrite a{' '}
          <Origin className="target default">default</Origin> content of Tooltip
          component.<br />
          <Origin
            className="target html"
            content="This is a <b>html</b> content.<br />Sanitized by <a href='#'>DOMPurify</a>.<script>console.log('Hello XSS!');</script>"
          >
            HTML
          </Origin>{' '}
          as string and{' '}
          <Origin className="target dom" content={dom}>
            DOM element
          </Origin>{' '}
          are also supported.
        </p>
